...
const ArFAQ = () => {
  ...
  const faqs = [
    { question: "كم عدد الشركاء لدينا؟", answer: "لدينا حاليًا أكثر من 15+ شريكًا." },
    { question: "كم عدد الخادمات اللاتي غادرن؟", answer: "لقد تم توظيف أكثر من 200+ خادمة بنجاح." },
    { question: "كم عدد سنوات الخبرة لدينا؟", answer: "لدينا أكثر من 2+ سنوات من الخبرة في الصناعة." },
  ];
