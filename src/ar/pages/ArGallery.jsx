  ...
  return (
    <div className="container gallery-page mx-auto px-4 py-8">
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-center mb-6 text-gold-500">معرض الصور</h2>
        <Slider {...settings}>
      ...
      <section>
        <h2 className="text-3xl font-bold text-center mb-6 text-gold-500">معرض الفيديو</h2>
        <Slider {...settings}>
